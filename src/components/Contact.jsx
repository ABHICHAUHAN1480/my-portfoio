...
const Contact = () => {
  ...
  <a 
    href="mailto:abhishekchauhan9717@gmail.com" 
    className="mr-4 text-gray-600 hover:text-black transition-colors duration-200"
    aria-label="Send an email to Abhishek Chauhan"
  >
